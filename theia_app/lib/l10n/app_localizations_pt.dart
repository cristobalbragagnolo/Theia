...
class AppLocalizationsPt extends AppLocalizations {
  ...
  String get infoAcknowledgementsBody =>
      'Os algoritmos de deep learning desta aplicação, como a ciência em geral, são construídos sobre o trabalho de quem veio antes de nós. Por isso quero agradecer a Mohamed (Moha) Abdelaziz, A. Jesús Muñoz-Pajares e Andrés Ferreira Rodríguez pelo seu trabalho de anotação e pelo seu grande apoio.\n\nEsta app foi feita com amor, curiosidade e muito trabalho. Por isso agradeço aos meus pais e à minha família, que me transmitiram esses valores.\n\nEspero que esta ferramenta seja útil para a investigação científica e ajude os que vêm depois de nós a descobrir e inventar coisas ainda melhores.';
