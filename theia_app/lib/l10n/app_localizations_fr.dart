...
class AppLocalizationsFr extends AppLocalizations {
  ...
  String get infoAcknowledgementsBody =>
      'Les algorithmes d\'apprentissage profond de cette application, comme la science en général, sont construits sur le travail de celles et ceux qui nous ont précédés. C\'est pourquoi je tiens à remercier Mohamed (Moha) Abdelaziz, A. Jesús Muñoz-Pajares et Andrés Ferreira Rodríguez pour leur travail d\'annotation et leur grand soutien.\n\nCette application a été créée avec amour, curiosité et beaucoup de travail. Je remercie donc mes parents et ma famille de m\'avoir transmis ces valeurs.\n\nJ\'espère que cet outil sera utile à la recherche scientifique et aidera ceux qui viendront après nous à découvrir et à inventer des choses encore meilleures.';
