...
class AppLocalizationsEs extends AppLocalizations {
  ...
  String get infoAcknowledgementsBody =>
      'Los algoritmos de deep learning de esta aplicación, como la ciencia en general, están construidos sobre el trabajo que hicieron otras personas antes que nosotros. Por eso quiero agradecer a Mohamed (Moha) Abdelaziz, A. Jesús Muñoz-Pajares y Andrés Ferreira Rodríguez por su trabajo de anotación y su gran apoyo.\n\nEsta app está hecha con amor, curiosidad y mucho trabajo. Por eso quiero agradecer a mis padres y a mi familia, que me inculcaron esos valores.\n\nEspero que esta herramienta sirva para la investigación científica y ayude a los que vienen después a descubrir e inventar cosas aún mejores.';
