...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get infoAcknowledgementsBody =>
      'Алгоритмы глубокого обучения в этом приложении, как и наука в целом, построены на труде тех, кто был до нас. Поэтому я хочу поблагодарить Mohamed (Moha) Abdelaziz, A. Jesús Muñoz-Pajares и Andrés Ferreira Rodríguez за их работу по аннотированию и большую поддержку.\n\nЭто приложение создано с любовью, любознательностью и большим трудом. Поэтому я благодарю своих родителей и семью, которые привили мне эти ценности.\n\nНадеюсь, этот инструмент пригодится научным исследованиям и поможет тем, кто придёт после нас, открывать и изобретать ещё лучшее.';
