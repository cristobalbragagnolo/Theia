...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String get infoAcknowledgementsBody =>
      'خوارزميات التعلم العميق في هذا التطبيق، كالعلم عمومًا، مبنية على عمل من سبقونا. لذلك أودّ أن أشكر Mohamed (Moha) Abdelaziz و A. Jesús Muñoz-Pajares و Andrés Ferreira Rodríguez على عملهم في وضع العلامات ودعمهم الكبير.\n\nصُنع هذا التطبيق بالحب والفضول والكثير من العمل، لذلك أشكر والديّ وعائلتي الذين غرسوا فيّ هذه القيم.\n\nآمل أن تفيد هذه الأداة البحث العلمي وأن تساعد من يأتون بعدنا على اكتشاف وابتكار أشياء أفضل.';
