...
class AppLocalizationsIt extends AppLocalizations {
  ...
  String get infoAcknowledgementsBody =>
      'Gli algoritmi di deep learning di questa app, come la scienza in generale, sono costruiti sul lavoro di chi è venuto prima di noi. Per questo voglio ringraziare Mohamed (Moha) Abdelaziz, A. Jesús Muñoz-Pajares e Andrés Ferreira Rodríguez per il loro lavoro di annotazione e il loro grande sostegno.\n\nQuesta app è stata creata con amore, curiosità e tanto lavoro. Perciò ringrazio i miei genitori e la mia famiglia, che mi hanno trasmesso questi valori.\n\nSpero che questo strumento sia utile alla ricerca scientifica e aiuti chi verrà dopo di noi a scoprire e inventare cose ancora migliori.';
