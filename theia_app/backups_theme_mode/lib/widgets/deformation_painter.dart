...
class DeformationPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final deformedShape = _calculateDeformedShape(meanShape, eigenvector, deformationFactor);
    ...
    _drawShape(canvas, meanPoints, scale, offset, Colors.grey.withOpacity(0.8), 2.0);
  ...
  void _drawShape(Canvas canvas, List<Offset> points, double scale, Offset offset, Color color, double strokeWidth) {
    final paint = Paint()
      ..color = color
