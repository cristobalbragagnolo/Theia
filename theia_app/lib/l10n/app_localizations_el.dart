...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get infoAcknowledgementsBody =>
      'Οι αλγόριθμοι βαθιάς μάθησης αυτής της εφαρμογής, όπως και η επιστήμη γενικότερα, είναι χτισμένοι πάνω στη δουλειά όσων ήρθαν πριν από εμάς. Γι\' αυτό θέλω να ευχαριστήσω τους Mohamed (Moha) Abdelaziz, A. Jesús Muñoz-Pajares και Andrés Ferreira Rodríguez για το έργο τους στην επισημείωση δεδομένων και τη μεγάλη τους υποστήριξη.\n\nΑυτή η εφαρμογή φτιάχτηκε με αγάπη, περιέργεια και πολλή δουλειά. Γι\' αυτό ευχαριστώ τους γονείς μου και την οικογένειά μου, που μου ενστάλαξαν αυτές τις αξίες.\n\nΕλπίζω αυτό το εργαλείο να φανεί χρήσιμο στην επιστημονική έρευνα και να βοηθήσει όσους έρθουν μετά από εμάς να ανακαλύψουν και να εφεύρουν ακόμη καλύτερα πράγματα.';
