...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get infoAcknowledgementsBody =>
      'Die Deep-Learning-Algorithmen dieser App bauen, wie die Wissenschaft im Allgemeinen, auf der Arbeit derer auf, die vor uns kamen. Deshalb möchte ich Mohamed (Moha) Abdelaziz, A. Jesús Muñoz-Pajares und Andrés Ferreira Rodríguez für ihre Annotationsarbeit und ihre große Unterstützung danken.\n\nDiese App wurde mit Liebe, Neugier und viel Arbeit geschaffen. Darum danke ich meinen Eltern und meiner Familie, die mir diese Werte vermittelt haben.\n\nIch hoffe, dieses Werkzeug ist der wissenschaftlichen Forschung von Nutzen und hilft denen, die nach uns kommen, noch bessere Dinge zu entdecken und zu erfinden.';
