...
class AppLocalizationsZh extends AppLocalizations {
  ...
  String get infoAcknowledgementsBody =>
      '本应用中的深度学习算法，正如科学本身，建立在前人工作的基础之上。因此，我要感谢 Mohamed (Moha) Abdelaziz、A. Jesús Muñoz-Pajares 和 Andrés Ferreira Rodríguez 的标注工作和大力支持。\n\n这个应用是用爱、好奇心和大量的努力打造的。为此，我要感谢我的父母和家人，是他们教会了我这些价值。\n\n希望这个工具能为科学研究贡献力量，并帮助后来者发现和创造更好的东西。';
